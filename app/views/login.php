                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-6">
                            <a href="index.html" class="app-brand-link">
                                ...
                                <span class="app-brand-text demo text-heading fw-bold">Politrack</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1">Bienvenido a Politrack! 👋</h4>
                        <p class="mb-6">Por favor, inicie sesión en su cuenta y comience la aventura</p>

                        <form id="formAuthentication" class="mb-4" action="?controller=Login&action=authenticate"
                            method="POST">
                            <div class="mb-6 form-control-validation">
                                <label for="email" class="form-label">Email o Nombre de Usuario</label>
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Ingrese su email o nombre de usuario" autofocus />
                            </div>
                            ...
                            <div class="my-8">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="/politrack/public/?controller=Auth&action=forgotPassword">
                        ...
                        <p class="text-center">
                            ...
                            <a href="/politrack/public/?controller=Register&action=index">
