...
<head>
    ...
    <title>Demo: Reset Password Basic - Pages | Vuexy - Bootstrap Dashboard PRO</title>
            ...
            <div class="authentication-inner py-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1">Reinicia tu contraseña 🔒</h4>
                        <p class="mb-6">
                            <span class="fw-medium">Tu nueva contraseña debe ser diferente de las contraseñas
                                utilizadas anteriormente</span>
                        </p>
                        <form id="formAuthentication" action="auth-login-basic.html" method="GET">
                            ...
                            <button class="btn btn-primary d-grid w-100 mb-6">Establecer nueva contraseña</button>
